#include "rpResolve2D.h"
#include <system.h>
#include <resources/frame.h>

RpResolve2D::~RpResolve2D() {}
RpResolve2D::RpResolve2D() {}

void RpResolve2D::setupAttachment() {
...
void RpResolve2D::setupDependency() {
