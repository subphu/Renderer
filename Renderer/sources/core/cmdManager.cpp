...
void CmdManager::beginOneTimeCommands( const VkCommandBuffer commandBuffer ) {
	LOG( "CmdBuffer::beginOneTimeCommands" );
...
void CmdManager::endOneTimeCommands( const VkCommandBuffer commandBuffer ) {
	LOG( "CmdBuffer::endOneTimeCommands" );
	const VkDevice device = System::Device()->getDevice();
