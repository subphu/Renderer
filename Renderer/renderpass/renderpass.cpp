...
void Renderpass::createRenderpass() {
	...
	VkResult result = vkCreateRenderPass(device, &mRenderpassInfo, nullptr, &mRenderpass);
	ASSERT_VKERROR(result, "failed to create render pass!");
	mCleaner.push([=](){ vkDestroyRenderPass(device, mRenderpass, nullptr); });
}
...
VkRenderPass Renderpass::get() { return mRenderpass; }
